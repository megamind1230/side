...
public partial class EditorViewModel : ViewModelBase
{
    ...
    public EditorViewModel(DeckService deckService, MainWindowViewModel mainViewModel, string? decksPath = null)
    {
    ...
    {
        var mdPath = Path.Combine(_decksPath, $"{deck.Id}.md");
    ...
    private void ImportToDeck()
    {
        ...
        {
            Log.Error(ex, "Failed to import deck {DeckId}", _deck?.Id);
