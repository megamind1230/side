...
public partial class LearningViewModel : ViewModelBase
{
    ...
    private void UpdateCurrentPage()
    {
        ...
        var h1Prefix = IsOrgFile ? "* " : "# ";
        var h2Prefix = IsOrgFile ? "** " : "## ";
        CurrentSectionBreadcrumb = !string.IsNullOrEmpty(CurrentSectionTitle) ? $"{h1Prefix}{CurrentSectionTitle}" : "";
        CurrentPageBreadcrumb = CurrentPage != null ? $"{h2Prefix}{CurrentPage.Title}" : "";

        RenderedContent = $"{h2Prefix}{CurrentPage?.Title ?? ""}\n\n{CurrentPage?.TextContent ?? ""}";
